...
def plot_conf_matrix_and_metrics(
    ...
    if n_bins > 15:
        ...
        annot_kws = {"size": font_size, "va": "center", "fontweight": "bold", "fontfamily": "Helvetica"}
...
for case_name, pred_bin in cases.items():
    ...
    acc, prec, rec, f1 = plot_conf_matrix_and_metrics(
        true_labels, pred_bin, save_path=fig_path, font_size=14,
...
csv_path = os.path.join(output_dir, f"C4S3_main_metrics_bin={n_bins}.csv")
metrics_df.to_csv(csv_path)

print(f"所有混淆矩阵图片和主指标已保存到 {output_dir}，bin={n_bins}")
