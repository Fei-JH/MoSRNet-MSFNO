...
# =========================================================
def C5S2_MS_FNO_signed_error_plus_intact(
...
# =========================================================
def C5S2_ResNet_signed_error_plus_intact(
    Intep_cfgpath,                 # reconstruction/interpolation cfg (e.g., MoSRNet)
...
def C5S2_reconstructed_withbaseline(
...
if __name__ == "__main__":
    """
    Execute C5S2: generate four figures
    ...
    All figures will be saved under: ./postprocessed/C5S2/fig/
    """
    ...
    # =================== 1) Original (MS-FNO) ===================
    out1 = C5S2_MS_FNO_signed_error_plus_intact(
    ...
    print("[C5S2] Saved:", out1)

    # =================== 2) Original (ResNet) ===================
    out2 = C5S2_ResNet_signed_error_plus_intact(
        Intep_cfgpath=INTEP_CFG,
    ...
    print("[C5S2] Saved:", out2)

    # 下采样重建后的预测
    p3 = C5S2_reconstructed_withbaseline(
        Intep_cfgpath=INTEP_CFG,
        MSFNO_cfgpath=MSFNO_CFG,
        ResNet_cfgpath=RESNET_CFG,
        predictor="msfno",
    ...
    p4 = C5S2_reconstructed_withbaseline(
        Intep_cfgpath=INTEP_CFG,
        MSFNO_cfgpath=MSFNO_CFG,
        ResNet_cfgpath=RESNET_CFG, 
        predictor="resnet",
